#!/usr/bin/env python3
"""
Wayfinder - AI Guide for Western Region Ghana (Final Strict Version)
"""
...
app.config['DATABASE_PATH'] = os.getenv('DATABASE_PATH', 'instance/wayfinder.db')
...
SYSTEM_PROMPT = """You are Wayfinder, a professional AI Guide for the Western Region of Ghana.
...
if __name__ == '__main__':
    print("🚀 Starting Wayfinder - Western Region Ghana Edition")
